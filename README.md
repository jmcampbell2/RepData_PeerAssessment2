...
5. Does the document have a synopsis that describes and summarizes the data analysis in less than 10 6. sentences?
...
* Your analysis must have <b>no more than three figures</b>. Figures may have multiple plots in them (i.e. panel plots), but there cannot be more than three figures total.
